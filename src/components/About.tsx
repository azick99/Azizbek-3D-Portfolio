    ...
    <>
      ...
      <div className="about-container">
        ...
        >
          ...
          <b className="text-[#915eff]">Software Developer</b> with a strong
          ...
          which, I can boost web perfomance, SEO and responsiveness, after, I
          try to test large projects and make them{" "}
